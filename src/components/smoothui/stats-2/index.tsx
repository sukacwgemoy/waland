...
export function StatsCards({
  title = "Key Metrics",
  description = "Lihat performa CS AI Anda melalui data-data penting ini",
  stats = [
    {
      value: "750K+",
      label: "CHAT TERTANGANI",
      description: "Percakapan pelanggan yang berhasil dijawab otomatis",
      icon: "DollarSign",
    ...
    },
    {
      ...
      description: "Bisnis yang mempercayai CS AI ini setiap hari",
      icon: "Users",
    ...
    },
    {
      ...
      description: "Rata-rata rating dari pengguna",
      icon: "Star",
    ...
    },
    {
      value: "0 Detik",
      label: "WAKTU TUNGGU",
      description: "Balasan instan tanpa delay",
      icon: "Smartphone",
